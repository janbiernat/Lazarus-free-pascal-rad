...
begin //FormCreate.
  Caption:= 'SQLite3 - Aktualizuj wybrany rekord (c)by Jan T. Biernat';
...
begin
  //Aktualizuj wybrany rekord: Akceptuj zmianę.
...
begin
  //Aktualizuj wybrany rekord: Anuluj.
...
begin
  //Aktualizuj wybrany rekord: Włącz możliwość aktualizowania.
    if(DBGrid1.Columns.Items[0].Field.AsInteger > 0) then begin
      ...
      with Panel1 do begin
        Width:= 229; Left:= 472; Enabled:= TRUE;
      end;
    end;
end;
...
begin
  ...
  MaskEdit1.Text:= '';
  with Panel1 do begin
    Width:= 229; Left:= -999; Enabled:= FALSE;
  end;
