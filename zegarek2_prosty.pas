...
begin //Timer1Timer.
  ...
  //=
    if(ZG_FormSzer < Form1.ClientWidth) then begin
      //Wykonaj poniższe instrukcje, gdy formatka jest powiększona.
        if(Label1.Width < (Form1.ClientWidth-124)) then
          Label1.Font.Size:= Label1.Font.Size+1
        else ZG_FormSzer:= Form1.ClientWidth;
    end else begin
               //Wykonaj poniższe instrukcje, gdy formatka jest pomniejszona.
                 if(Label1.Width > (Form1.ClientWidth-124)) then
                   Label1.Font.Size:= Label1.Font.Size-1
                 else ZG_FormSzer:= Form1.ClientWidth;
             end;
